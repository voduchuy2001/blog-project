            ...
            <div class="align-items-center d-flex h-100">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="mb-3">
                            <input class="form-control" type="password" required="" id="password-confirmation"
                                placeholder="Enter confirm password" name="password_confirmation">
                        </div>
                        <div class="d-grid mb-0 text-center">
                            <button class="btn btn-primary" type="submit"><i class="mdi mdi-login"></i> Update password
                            </button>
                        </div>
                    </form>
                    <!-- end form-->
