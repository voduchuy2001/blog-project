                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="justified-tabs-preview">
                                <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                    ...
                                    <li class="nav-item">
                                        <a href="#post-elements" data-bs-toggle="tab" aria-expanded="true"
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="post-elements">
                                        <div class="mt-3 mb-3">
                                            <label for="postTitle" class="form-label">Title</label>
                                            <input type="text" class="form-control" name="postTitle"
                                                placeholder="Post title" id="postTitle" value="{{ $post->postTitle }}">
                                            @error('postTitle')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" accept="image/*" class="form-control" name="fImagePost"
                                                id="fImagePost" value="{{ $post->fImagePost }}">
                                            @error('fImagePost')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select selecte2 mb-3" data-toggle="select2"
                                                name="category_id" id="category">
                                                @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" @if ($post->category->id ==
                                                    $category->id)
                                                    selected
                                                    @endif
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="tags[]" id="tags"
                                                class="form-control select2 select2-multiple" data-toggle="select2"
                                                multiple="multiple">
                                                @foreach ($tags as $tag)
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="satus_yess"
                                                    name="status" value="yes" @if ($post->status === 'featured')
                                                checked
                                                @endif>
                                                <label class="form-check-label" for="satus_yess">Set featured
                                                    post</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="SEO">
                                        <div class="mt-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="metaTitle"
                                                placeholder="Meta title" id="postTitle" value="{{ $post->metaTitle }}">
                                            @error('metaTitle')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="meteDes"
                                                placeholder="Meta description" id="postTitle"
                                                value="{{ $post->meteDes }}">
                                            @error('meteDes')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="metaKey"
                                                placeholder="Meta key words" id="postTitle"
                                                value="{{ $post->metaKey }}">
                                            @error('metaKey')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
